...
ActiveRecord::Schema.define(version: 2019_12_21_013701) do
  ...
  create_table "devices", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "internal_name", default: "", null: false
    t.index ["schedule_id"], name: "index_devices_on_schedule_id"
  ...
  create_table "scheduled_media", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "times_per_hour", default: 1, null: false
    t.bigint "media_id"
    t.bigint "schedule_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["media_id"], name: "index_scheduled_media_on_media_id"
    t.index ["schedule_id"], name: "index_scheduled_media_on_schedule_id"
  end
  ...
  create_table "user_actions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "author", default: "N/A", null: false
